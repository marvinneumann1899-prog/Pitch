...
**GitHub (03.06.):** Eigenes privates Repo erstellt und gepusht: `marvinneumann1899-prog/Pitch` (`main`, Remote `origin`). Nick-Zugriff: noch GitHub-Username/Einladung offen.
