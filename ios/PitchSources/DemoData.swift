...
let demoPeople: [DemoProfile] = [
    ...
    DemoProfile(
        ...
        fields: [f("calendar","Alter","21"), f("figure.soccer","Position","Linksaußen"),
                 f("mappin.and.ellipse","Location","Untersteinbach"), f("shield.fill","Verein","TSV Untersteinbach"),
    ...
    DemoProfile(
        ...
        fields: [f("calendar","Alter","24"), f("figure.soccer","Position","Zentrales Mittelfeld"),
                 f("mappin.and.ellipse","Location","Schwäbisch Hall"), f("shield.fill","Verein","SV APAG"),
    ...
    DemoProfile(
        ...
        fields: [f("calendar","Alter","38"), f("clock.fill","Erfahrung","9 Jahre"),
                 f("trophy.fill","Aktuelle Liga","Kreisliga A"), f("mappin.and.ellipse","Location","Untersteinbach"),
    ...
    DemoProfile(
        ...
        fields: [f("calendar","Alter","43"), f("clock.fill","Erfahrung","13 Jahre"),
                 f("trophy.fill","Aktuelle Liga","Kreisliga A"), f("mappin.and.ellipse","Location","Waldenburg"),
    ...
    DemoProfile(
        ...
        fields: [f("calendar","Gegründet","1925"), f("trophy.fill","Liga","Kreisliga A"),
                 f("mappin.and.ellipse","Location","Pfedelbach"), f("sportscourt.fill","Heimstätte","Sportplatz Untersteinbach"),
